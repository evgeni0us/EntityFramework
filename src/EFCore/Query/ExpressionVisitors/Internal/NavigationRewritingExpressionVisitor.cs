...
namespace Microsoft.EntityFrameworkCore.Query.ExpressionVisitors.Internal
{
    ...
    public class NavigationRewritingExpressionVisitor : RelinqExpressionVisitor
    {
        ...
        protected override Expression VisitMember(MemberExpression node)
        {
                    ...
                    (ps, qs) =>
                        {
                            if (qs != null)
                            {
                                return RewriteNavigationProperties(
                                    ...
                                    node.Member.Name,
                                    node.Type,
                                    e => EntityQueryModelVisitor.MakeMemberAccess(e, node.Member),
                                    e => new NullConditionalExpression(e, e, EntityQueryModelVisitor.MakeMemberAccess(e, node.Member)));
                            }
            ...
            return _insideInnerKeySelector && _innerKeySelectorRequiresNullRefProtection
                ? (Expression)new NullConditionalExpression(
                    newExpression, 
                    newExpression, 
                    EntityQueryModelVisitor.MakeMemberAccess(newExpression, node.Member))
                : EntityQueryModelVisitor.MakeMemberAccess(newExpression, node.Member);
        }
        ...
        {
            var propertyExpression = EntityQueryModelVisitor.CreatePropertyExpression(target, property, makeNullable: false);
